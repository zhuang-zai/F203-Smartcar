...
// 速度档位定义
#define SPEED_BASE  400  // 直道和普通大弯的基础速度
#define SPEED_SLOW  400  // 连续直角弯的安全过弯速度
#define ROUNDABOUT_ZONE_MIN  350000  // 进入苯环预警区 (提前一点睁眼)
#define ROUNDABOUT_ZONE_MAX  850000 // 离开苯环预警区 (过完环岛后彻底闭眼)
...
{
    chassis.target_speed = 450;       // 初始化目标速度为 300   max : 1100  最佳  400
...
//				Speed_Plan_Task();
				...
				Lap_Control_Task(); // ?? 每 2ms 执行一次圈数判定与安全停车判断
