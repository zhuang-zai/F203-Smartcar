...
void UpdatePwm(u8 PWM, PWMx_Duty *PWMx)
{
	switch (PWM)
	{
	case PWM1:		PWMA_Duty1(PWMx->PWM1_Duty);		break;
	case PWM2:		PWMA_Duty2(PWMx->PWM2_Duty);		break;
	case PWM3:		PWMA_Duty3(PWMx->PWM3_Duty);		break;
	case PWM4:		PWMA_Duty4(PWMx->PWM4_Duty);		break;
	case PWM5:		PWMB_Duty5(PWMx->PWM5_Duty);		break;
	case PWM6:		PWMB_Duty6(PWMx->PWM6_Duty);		break;
	case PWM7:		PWMB_Duty7(PWMx->PWM7_Duty);		break;
	case PWM8:		PWMB_Duty8(PWMx->PWM8_Duty);		break;
	case PWMA:
...
void UpdatePwmCh(u8 PWM_CH, u16 Duty)
{
	switch (PWM_CH)
	{
	case PWM1:		PWMA_Duty1(Duty);		break;
	case PWM2:		PWMA_Duty2(Duty);		break;
	case PWM3:		PWMA_Duty3(Duty);		break;
	case PWM4:		PWMA_Duty4(Duty);		break;
	case PWM5:		PWMB_Duty5(Duty);		break;
	case PWM6:		PWMB_Duty6(Duty);		break;
	case PWM7:		PWMB_Duty7(Duty);		break;
	case PWM8:		PWMB_Duty8(Duty);		break;
	case PWMA:
		PWMA_Duty1(Duty);
		PWMA_Duty2(Duty);
		PWMA_Duty3(Duty);
