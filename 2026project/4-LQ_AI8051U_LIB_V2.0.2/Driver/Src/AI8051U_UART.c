...
{
    for (; *puts != 0;	puts++)  UART1_PutBuf(*puts); 	//遇到停止符0结束
}
...
{
    for (; *puts != 0;	puts++)  UART2_PutBuf(*puts); 	//遇到停止符0结束
}
...
{
    for (; *puts != 0;	puts++)  UART3_PutBuf(*puts); 	//遇到停止符0结束
}
...
{
    for (; *puts != 0;	puts++)  UART4_PutBuf(*puts); 	//遇到停止符0结束
}
