...
void OLED_Init(void)
{
    gpio_init_pin(OLED_CLK_PIN, GPIO_Mode_Out_PP);
    gpio_init_pin(OLED_RST_PIN, GPIO_Mode_Out_PP);
    gpio_init_pin(OLED_DI_PIN, GPIO_Mode_Out_PP);
    gpio_init_pin(OLED_DC_PIN, GPIO_Mode_Out_PP);
    gpio_init_pin(OLED_CS_PIN, GPIO_Mode_Out_PP);

    OLED_CK_H;
    OLED_CS_H;	//预制SLK和SS为高电平
	OLED_RST_L;
    delay_ms(50);
    OLED_RST_H;
