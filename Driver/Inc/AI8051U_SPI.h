...
#define		SPI_IOSW_Enable(n)				HSSPI_CFG2 |= 0x40       //交换MMSI和MISO脚位
#define		SPI_IOSW_Disable(n)				HSSPI_CFG2 &= ~0x40      //默认 不交换MMSI和MISO脚位
//========================================================================
//                              定义声明
//========================================================================
...
#ifdef  AI8051U_32Bit   //如果是AI8051U则使用此管脚定义
