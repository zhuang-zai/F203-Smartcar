...
{
    //左轮速度环 增量式PI
    {6.0f, 1.0f, 0.0f, 3000,-3000,PID_INCREMENT},     // 1.2   0.2    速度400/450限幅原来是+-2800
    //右轮速度环 增量式PI
    {6.0f, 1.0f, 0.0f, 3000,-3000,PID_INCREMENT},
    //方向环 位置式PD
    {400.0f, 0.0f, 150.0f, 18000,-18000, PID_POSITION},  // speed = 300时， P = 400，D = 120   限幅正负 8000 10000    速度为450/400时，限幅正负15000  
